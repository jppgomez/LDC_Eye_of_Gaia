...
(function(window2, undefined2) {
  window2.tracking = window2.tracking || {};
  ...
  tracking.initUserMedia_ = function(element, opt_options) {
    window2.navigator.getUserMedia(
      {
        video: true,
      ...
      function(stream) {
        try {
          element.src = window2.URL.createObjectURL(stream);
        } catch (err) {
          element.src = stream;
        }
      },
  ...
  tracking.trackVideo_ = function(element, tracker) {
    ...
    var requestAnimationFrame_ = function() {
      requestId = window2.requestAnimationFrame(function() {
    ...
    task.on("stop", function() {
      window2.cancelAnimationFrame(requestId);
    });
    task.on("run", function() {
      requestAnimationFrame_();
    });
  ...
  if (!window2.URL) {
    window2.URL = window2.URL || window2.webkitURL || window2.msURL || window2.oURL;
  }
...
(function() {
  ...
  tracking.ViolaJones.evalStages_ = function(data, integralImage, integralImageSquare, tiltedIntegralImage, i, j, width, blockWidth, blockHeight, scale) {
    var inverseArea = 1 / (blockWidth * blockHeight);
    var wbA = i * width + j;
    var wbB = wbA + blockWidth;
    var wbD = wbA + blockHeight * width;
    var wbC = wbD + blockWidth;
